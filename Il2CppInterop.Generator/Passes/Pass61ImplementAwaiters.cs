    ...
    public static void DoPass(RewriteGlobalContext context)
    {
        ...
        foreach (var assemblyContext in context.Assemblies)
        {
            ...
            foreach (var typeContext in assemblyContext.Types)
            {
                ...
                var sig = AsmResolverExtensions.SigCreateInstance(voidRef, [actionUntypedRef.Value.ToTypeSignature()]);
                ...
                if (genericParameterCount > 0)
                {
                    ...
                    var interopOnCompleteGeneric = typeContext.NewType.AsmMakeGenericInstanceType(typeArguments)
                        .ToTypeDefOrRef()
