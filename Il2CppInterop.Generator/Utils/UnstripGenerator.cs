...
public static class UnstripGenerator
{
        ...
        MethodDefinition convertedMethod, RuntimeAssemblyReferences imports)
    {
        ...
        var constructor = new MethodDefinition(".ctor",
            ...
            MethodAttributes.Public, AsmResolverExtensions.SigCreateInstance(imports.Module.Void(), imports.Module.Object(), imports.Module.IntPtr()));
        ...
        var invokeMethod = new MethodDefinition("Invoke",
            ...
            AsmResolverExtensions.SigCreateInstance(imports.Module.Void())); // todo
        ...
        MethodDefinition unityMethod, RuntimeAssemblyReferences imports)
    {
        ...
        var methodRef = imports.IL2CPP_ResolveICall.Value.AsmMakeGenericInstanceMethod(delegateType.ToTypeSignature());
